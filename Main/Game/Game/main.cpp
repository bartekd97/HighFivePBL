...
int main()
{
	...
	HFEngine::ECS.GetComponent<Transform>(cameraObject).SetPosition({ 100.0f, 35.0f, 120.0f });
	HFEngine::ECS.GetComponent<Transform>(cameraObject).SetRotation({ -55.0f, 0.0f, 0.0f });
